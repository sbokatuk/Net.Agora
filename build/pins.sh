...
# Pinned versions of the platform packages Net.Agora.Video depends on — published from the
...
# This repository's own version (tracks the iOS platform package's native version component — see
